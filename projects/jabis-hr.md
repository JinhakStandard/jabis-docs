...
## jabis 메인 앱 통합 상태
> 2026-02-14: 전자결재 관리 기능이 jabis 메인 앱(`/hr/approval-admin/*`)에 내장됨
> 2026-02-15: 조직도 관리/사용자 관리 제거 — 조직 설정은 실제 조직도 DB에서 가져오는 방향으로 전환
> 2026-02-15: 조직/관리 메뉴 제거 — jabis 메인 앱/jabis-hr 양쪽에서 조직 관리 메뉴 및 라우트 삭제

jabis 메인 앱에 통합된 기능:
- 양식 관리 (`/hr/approval-admin/forms`)
